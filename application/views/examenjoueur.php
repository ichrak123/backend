...
<?php echo base_url();?>/assets/img/undraw_profile.svg">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Liste des examens de grade des joueurs</h1>
					
				<div class="embed-responsive embed-responsive-16by9">
  <iframe class="embed-responsive-item" src='<?php echo base_url('examples/examenjoueur');?>' allowfullscreen></iframe>
</div>
