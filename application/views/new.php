                ...
                <div id="collapseexam" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                 ...
                 <a class="collapse-item" href='<?php echo site_url('examples/examenjoueurview')?>'>Grade joueur</a>
                        <a class="collapse-item" href='<?php echo site_url('examples/examencoachview')?>'>Grade Coach</a>
                         <a class="collapse-item" href='<?php echo site_url('examples/examenarbitreview')?>'>Grade grade</a>
                    </div>
                </div>
            </li>
             <li class="nav-item">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xxs font-weight-bold text-warning text-uppercase mb-1">
                                               Les coachs </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $ichrak ; ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-user-friends fa-2x text-gray-300"></i>
                                        </div>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xxs font-weight-bold text-primary text-uppercase mb-1">
                                                Les demandes licences de joueurs </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $player ; ?></div>
                                        </div>
                                        <div class="col-auto">
                                             <i class="fas fa-user-friends fa-2x text-gray-300"></i>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-secondary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xxs font-weight-bold text-secondary text-uppercase mb-1">
                                                Les demandes des licences de coach</div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-dark shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xxs font-weight-bold text-dark text-uppercase mb-1">Les competitions
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
