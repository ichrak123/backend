...
<?php echo base_url();?>/assets/img/undraw_profile.svg">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Liste des categories</h1>
					
				<div class="embed-responsive embed-responsive-16by9">
  <iframe class="embed-responsive-item" src='<?php echo base_url('examples/categorie');?>' allowfullscreen></iframe>
</div>
